...
public class AICarRoute : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (MarkTracker == 44)
		{
			TheMarker.transform.position = Mark45.transform.position;
		}
		if (MarkTracker == 45)
		{
			TheMarker.transform.position = Mark46.transform.position;
		}
		if (MarkTracker == 46)
		{
			TheMarker.transform.position = Mark47.transform.position;
		}
	}
